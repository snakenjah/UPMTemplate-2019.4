...
<root>
  ...
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── if.packages.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── if.packages.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `if.packages`.
